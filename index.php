...
?>
<?$APPLICATION->IncludeComponent("bitrix:news.list", "index_menu", Array(
	...
	false
);?><?$APPLICATION->IncludeComponent("bitrix:news.list", "index_info", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"CHECK_FIELD_PHONE" => "Y",
		"CHECK_FIELD_TEXT" => "N",
		"EMAIL_TO" => "korehovrabota@yandex.ru",
		"EVENT_MESSAGE_ID" => array("11"),
		"FIELD_EMAIL_TITLE" => "Ваш Email:",
		"FIELD_NAME_TITLE" => "ФИО",
		"FIELD_PHONE_TITLE" => "Телефон",
		"FIELD_TEXT_TITLE" => "Текст сообщения:",
