    ...
    <main>
        ...
        <section class="breadcrumbs">
            <div class="container">
               ...
               <span href="/" class="breadcrumbs-item">Наши врачи</span>
            </div>
        </section>
        ...
        <section class="doctors_list">
            <div class="container">
                <ul class="doctors_list-list">
                    <li>
                        <a href="#">
                            <div>
                                <img src="source/img/doctors_page/doctor_1.jpg" alt="">
                            </div>
                            <h3>Неделенко Галина Николаевна</h3>
                            <p>Директор ООО «Зеленое Яблоко», Зубной врач, Рентгенолог лаборант.</p>
                        </a>
                    </li>
                    <li>
                        <a href="#">
